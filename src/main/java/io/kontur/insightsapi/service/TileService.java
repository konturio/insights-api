...
public class TileService {
    ...
    public byte[] getBivariateTileMvt(Integer z, Integer x, Integer y, String indicatorsClass) {
        ...
        return tileRepository.getBivariateTileMvt(getResolution(z), x, y, bivariateIndicators);
    }
    ...
    public byte[] getBivariateTileMvtIndicatorsList(Integer z, Integer x, Integer y, List<String> indicatorsList) {
        ...
        if (useStatSeparateTables) {
            return tileRepository.getBivariateTileMvtIndicatorsListV2(resolution, x, y, indicators);
        }
        return tileRepository.getBivariateTileMvt(resolution, x, y, indicators);
    }
